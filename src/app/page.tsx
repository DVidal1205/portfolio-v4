...
export default function Home() {
    ...
    return (
        <BackgroundGradientAnimation interactive={false} size={"70%"}>
            ...
            <AnimatePresence>
                {showCallToAction && (
                    <motion.div
                        ...
                        className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-[110] flex flex-col items-center space-y-2"
                    >
                        <motion.p
