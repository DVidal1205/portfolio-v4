...
export const NavItems = ({ items, className, onItemClick }: NavItemsProps) => {
    ...
    return (
        <motion.div
            ...
            className={cn(
                "absolute inset-0 hidden flex-1 flex-row items-center justify-center space-x-4 text-xl font-medium text-foreground transition duration-200 hover:text-primary-800 lg:flex lg:space-x-4",
                className
            )}
        >
            {items.map((item, idx) => (
        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    exit={{ opacity: 0 }}
                    className={cn(
                        "absolute inset-x-0 top-16 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-lg bg-bg-purple-900 px-4 py-8 shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05)]",
                        className
                    )}
                >
                    {children}
...
export const NavbarButton = ({
    ...
    const baseStyles =
        "hover:bg-primary-800/80 px-6 py-3 rounded-md bg-neutral-900 text-foreground text-base font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center";
